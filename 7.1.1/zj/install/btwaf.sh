...
#public_file=/www/server/panel/install/public.sh
	...
	#wget -O $public_file $cjqbt_Url/install/public.sh -T 5;
#fi
...
{ 
	...
	if [ "$pyVersion" == 2 ];then
		...
		wget -O $pluginPath/btwaf_main.cpython-36m-x86_64-linux-gnu.zip $cjqbt_Url/btwaf_rule/test/btwaf/btwaf_main.cpython-36m-x86_64-linux-gnu.zip -T 5
	...
	wget -O $pluginPath/info.json $cjqbt_Url/btwaf_rule/test/btwaf/info.json -T 5
	wget -O $pluginPath/icon.png $cjqbt_Url/btwaf_rule/test/btwaf/icon.png -T 5
	wget -O /www/server/panel/vhost/nginx/btwaf.conf $cjqbt_Url/btwaf_rule/test/btwaf/btwaf.conf -T 5
	\cp -a -r /www/server/panel/plugin/btwaf/icon.png /www/server/panel/static/img/soft_ico/ico-btwaf.png
	wget -O $pluginPath/btwaf.zip $cjqbt_Url/btwaf_rule/test/btwaf/btwaf.zip -T 5
