...
#public_file=/www/server/panel/install/public.sh
	...
	#wget -O $public_file $btsb_Url/install/public.sh -T 5;
#fi
...
{ 
	...
	Install_socket
	mkdir -p $pluginPath
	wget -O $pluginPath/firewalls_list.py $btsb_Url/btwaf_rule/test/btwaf/firewalls_list.py -T 5
	...
	if [ "$pyVersion" == 2 ];then
		wget -O $pluginPath/btwaf_main.zip $btsb_Url/btwaf_rule/test/btwaf/btwaf_main.zip -T 5
		unzip -o $pluginPath/btwaf_main.zip -d $pluginPath > /dev/null
		rm -rf $pluginPath/btwaf_main.zip
	else
		wget -O $pluginPath/btwaf_main.cpython-36m-x86_64-linux-gnu.zip $btsb_Url/btwaf_rule/test/btwaf/btwaf_main.cpython-36m-x86_64-linux-gnu.zip -T 5
	...
	wget -O $pluginPath/btwaf_main.py $btsb_Url/btwaf_rule/test/btwaf/btwaf_main.py -T 5
	wget -O $pluginPath/firewalls_list.py $btsb_Url/btwaf_rule/test/btwaf/firewalls_list.py -T 5
	wget -O $pluginPath/index.html $btsb_Url/btwaf_rule/test/btwaf/index.html -T 5
	wget -O $pluginPath/info.json $btsb_Url/btwaf_rule/test/btwaf/info.json -T 5
	wget -O $pluginPath/icon.png $btsb_Url/btwaf_rule/test/btwaf/icon.png -T 5
	wget -O /www/server/panel/vhost/nginx/btwaf.conf $btsb_Url/btwaf_rule/test/btwaf/btwaf.conf -T 5
	\cp -a -r /www/server/panel/plugin/btwaf/icon.png /www/server/panel/static/img/soft_ico/ico-btwaf.png
	wget -O $pluginPath/btwaf.zip $btsb_Url/btwaf_rule/test/btwaf/btwaf.zip -T 5
